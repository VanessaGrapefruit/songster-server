...
const favoriteSongsAdd =  async function favorite_add(req: express.Request, res: express.Response) {
...
const favoriteSongsDelete = async function favorite_delete (req, res) {
...
const favoriteSongsList = async function favorite_songs_list (req: express.Request, res: express.Response) {
